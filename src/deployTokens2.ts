...
import {DefaultSigner, OpenApiProvider, PrivateKey, SupportedNetwork, toByteString} from '@opcat-labs/scrypt-ts-opcat'
...
const network: SupportedNetwork = 'opcat-testnet'
...
const main = async () => {
    for (const token of tokenInfos.slice(0, 2)) {
